...
import (
	...
	"github.com/Pedro-lmso-erp/erp/src/tools/exceptions"
...
// Initialize starts the base logger used by all erp components
func Initialize() {
...
func LogPanicData(panicData interface{}) error {
	...
	log.Error("erp panicked", "msg", msg)
