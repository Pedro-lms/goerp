...
import (
	...
	"github.com/Pedro-lmso-erp/pool/{{ .QueryPackageName }}/{{ .SnakeName }}"
)
...
// {{ $.Name }}ConditionerpFunc is a dummy function to uniquely match interfaces.
func (c Condition) {{ $.Name }}ConditionerpFunc() {}
