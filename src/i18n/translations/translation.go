...
import (
	...
	"github.com/Pedro-lmso-erp/erp/src/tools/po"
...
// executeCustomPoFuncs executes all methods registered by erp modules
...
func addResourceItemsToMessages(lang string, resourcesDir string, messages MessageMap) MessageMap {
	...
	for _, fileName := range xmlFiles {
		...
		for _, dataTag := range doc.FindElements("erp/data") {
